...
# P0-B first (fast, ~50 min): FinBERT with LLRD 0.9
...
# P0-A retry (slow, ~2h40): DeBERTa-v3-large 8ep fix-text
Write-Host "=== P0-A: DeBERTa-v3-large 8ep fix-text lr=8e-6 (retry) ===" -ForegroundColor Cyan
...
Write-Host "PHASE 0B EXPERIMENTS DONE" -ForegroundColor Yellow
