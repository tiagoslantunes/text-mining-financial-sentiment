...
python scripts\run_transformer_cv.py --model-name nickmuchi/finbert-tone-finetuned-fintwitter-classification --tag finbert_fintwitter --epochs 5 --maxlen 128 --lr 1e-5 --weight-decay 0.01 --batch-size 16 --label-smoothing 0.05 --warmup-ratio 0.06 --schedule cosine --amp-dtype fp16 --n-folds $FOLDS
...
python scripts\run_transformer_cv.py --model-name nickmuchi/finbert-tone-finetuned-fintwitter-classification --tag finbert_fintwitter_7ep --epochs 7 --maxlen 128 --lr 8e-6 --weight-decay 0.01 --batch-size 16 --label-smoothing 0.05 --warmup-ratio 0.06 --schedule cosine --amp-dtype fp16 --n-folds $FOLDS
...
python scripts\run_transformer_cv.py --model-name nickmuchi/finbert-tone-finetuned-fintwitter-classification --tag finbert_fintwitter_10ep --epochs 10 --maxlen 128 --lr 5e-6 --weight-decay 0.01 --batch-size 16 --label-smoothing 0.05 --warmup-ratio 0.06 --schedule cosine --amp-dtype fp16 --n-folds $FOLDS
...
python scripts\run_transformer_cv.py --model-name nickmuchi/finbert-tone-finetuned-fintwitter-classification --tag finbert_fintwitter_10ep_fixtext --epochs 10 --maxlen 128 --lr 5e-6 --weight-decay 0.01 --batch-size 16 --label-smoothing 0.05 --warmup-ratio 0.06 --schedule cosine --amp-dtype fp16 --fix-text --n-folds $FOLDS
...
python scripts\run_transformer_cv.py --model-name cardiffnlp/twitter-roberta-large-topic-sentiment-latest --tag roberta_large_ts_v2 --epochs 5 --maxlen 128 --lr 1e-5 --weight-decay 0.01 --batch-size 16 --label-smoothing 0.05 --warmup-ratio 0.06 --schedule cosine --amp-dtype fp16 --n-folds $FOLDS
...
python scripts\run_transformer_cv.py --model-name microsoft/deberta-v3-large --tag debertav3_large_6ep --epochs 6 --maxlen 128 --lr 1e-5 --weight-decay 0.01 --batch-size 8 --grad-accum 4 --label-smoothing 0.05 --warmup-ratio 0.1 --schedule cosine --amp-dtype fp16 --n-folds $FOLDS
...
python scripts\run_transformer_cv.py --model-name microsoft/deberta-v3-large --tag debertav3_large_6ep_fixtext --epochs 6 --maxlen 128 --lr 1e-5 --weight-decay 0.01 --batch-size 8 --grad-accum 4 --label-smoothing 0.05 --warmup-ratio 0.1 --schedule cosine --amp-dtype fp16 --fix-text --n-folds $FOLDS
