...
\begin{itemize}
  ...
  session keeps conversational memory: \texttt{why} / \texttt{history} / \texttt{stats} /
  \texttt{compare:} follow-ups are supported (\texttt{ConversationBufferMemory} in the LangChain
  back-end).
\end{itemize}
